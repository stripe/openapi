...
* ⚠️ Change type of `CreditNoteLineItemTaxesTaxRateDetails.TaxRate`, `CreditNoteTotalTaxesTaxRateDetails.TaxRate`, `InvoiceLineItemTaxesTaxRateDetails.TaxRate`, and `InvoiceTotalTaxesTaxRateDetails.TaxRate` from `string` to `expandable($TaxRate)`

...
* ⚠️ Change type of `CreditNote.TotalTaxes.TaxRateDetails.TaxRate`, `CreditNoteLineItem.Taxes.TaxRateDetails.TaxRate`, `Invoice.TotalTaxes.TaxRateDetails.TaxRate`, and `InvoiceLineItem.Taxes.TaxRateDetails.TaxRate` from `string` to `expandable($TaxRate)`
